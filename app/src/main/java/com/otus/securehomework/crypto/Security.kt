...
//https://github.com/vitalyraevsky/otus_security/blob/master/app/src/main/java/com/otus/myapplication/crypto/Security.kt
class Security @Inject constructor() {
    ...
    fun decryptAes(encrypted: String, key: Key): String {
        ...
        Log.d("MyLog","decryptAes $encrypted $key $decoded ")
