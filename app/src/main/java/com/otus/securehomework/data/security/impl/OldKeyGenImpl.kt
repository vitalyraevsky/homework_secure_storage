...
import com.otus.securehomework.data.security.Constants.ENCRYPTED_KEY_NAME
import com.otus.securehomework.data.security.Constants.KEY_PROVIDER
import com.otus.securehomework.data.security.Constants.RSA_ALGORITHM
import com.otus.securehomework.data.security.Constants.RSA_KEY_ALIAS
import com.otus.securehomework.data.security.Constants.RSA_MODE_LESS_THAN_M
import com.otus.securehomework.data.security.Constants.SHARED_PREFERENCE_NAME
...
class OldKeyGenImpl @Inject constructor(
    ...
    override fun generate(): SecretKey = getAesSecretKey() ?: generateAesSecretKey()
