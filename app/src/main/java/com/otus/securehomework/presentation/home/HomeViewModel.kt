...
@Inject constructor(
    ...
    val isAuthBiometryEnabled = userPreferences.authWithBiometry.asLiveData()
    ...
    fun updateAuthBiometrySetting(isEnabled: Boolean) {
        viewModelScope.launch {
            userPreferences.changeBiometrySetting(isEnabled)
        }
    }
}